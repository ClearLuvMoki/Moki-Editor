...
import React__default, { forwardRef, createContext, createElement, memo as memo$1, useContext, useRef, useState, useDebugValue, useEffect, useLayoutEffect, useMemo, useCallback, useImperativeHandle, isValidElement, cloneElement, Fragment as Fragment$2, useId, Children, useInsertionEffect } from 'react';
...
var $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document !== "undefined" ? (React__default).useLayoutEffect : () => {
};
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState, Component: Component2 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return jsxs(MotionContext.Provider, { value: context, children: [MeasureLayout && context.visualElement ? jsx(MeasureLayout, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component2, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement)] });
  }
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component2 !== Fragment$2 ? { ...filteredProps, ...visualProps, ref } : {};
...
var createDomVisualElement = (Component2, options) => {
  return isSVGComponent(Component2) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component2 !== Fragment$2
  });
};
...
function LazyMotion({ children, features, strict = false }) {
  ...
  return jsx(LazyContext.Provider, { value: { renderer: loadedRenderer.current, strict }, children });
}
...
var $e6afbd83fe6ebbd2$var$FocusableContext = /* @__PURE__ */ (React__default).createContext(null);
...
var $ae1eeba8b9eafd08$export$5165eccb35aaadb5 = (React__default).createContext({
  register: () => {
  }
});
...
var Ripple = (props) => {
  ...
  return /* @__PURE__ */ jsx(Fragment$1, { children: ripples.map((ripple) => {
...
var Button = forwardRef5((props, ref) => {
  const {
    ...
    styles,
    spinnerSize,
    spinner: spinner2 = /* @__PURE__ */ jsx(spinner_default, { color: "current", size: spinnerSize }),
    spinnerPlacement,
    startContent,
    endContent,
    isLoading,
  ...
  return /* @__PURE__ */ jsxs(Component2, { ref: domRef, className: styles, ...getButtonProps(), children: [
    startContent,
...
var ActionsArr = [
  { icon: /* @__PURE__ */ jsx(Undo2, { ...ToolbarIconProps }), type: "undo" },
  { icon: /* @__PURE__ */ jsx(Redo2, { ...ToolbarIconProps }), type: "redo" },
  { icon: /* @__PURE__ */ jsx(Pilcrow, { ...ToolbarIconProps }), type: "heading" },
  { icon: /* @__PURE__ */ jsx(Bold2, { ...ToolbarIconProps }), type: "bold" },
  { icon: /* @__PURE__ */ jsx(Italic2, { ...ToolbarIconProps }), type: "italic" },
  { icon: /* @__PURE__ */ jsx(Underline2, { ...ToolbarIconProps }), type: "underline" },
  { icon: /* @__PURE__ */ jsx(Strikethrough, { ...ToolbarIconProps }), type: "strike" },
  { icon: /* @__PURE__ */ jsx(Braces, { ...ToolbarIconProps }), type: "code" },
  { icon: /* @__PURE__ */ jsx(Subscript, { ...ToolbarIconProps }), type: "subscript" },
  { icon: /* @__PURE__ */ jsx(Superscript, { ...ToolbarIconProps }), type: "superscript" },
  { icon: /* @__PURE__ */ jsx(Sheet, { ...ToolbarIconProps }), type: "table" },
  { icon: /* @__PURE__ */ jsx(Baseline, { ...ToolbarIconProps }), type: "textStyle" },
  { icon: /* @__PURE__ */ jsx(PaintRoller, { ...ToolbarIconProps }), type: "highlight" },
  { icon: /* @__PURE__ */ jsx(ListMinus, { ...ToolbarIconProps }), type: "textAlign" },
  { icon: /* @__PURE__ */ jsx(ListOrdered, { ...ToolbarIconProps }), type: "bulletList" },
  { icon: /* @__PURE__ */ jsx(List, { ...ToolbarIconProps }), type: "orderedList" },
  { icon: /* @__PURE__ */ jsx(TextQuote, { ...ToolbarIconProps }), type: "blockquote" }
];
var Toolbar = memo$1(() => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full h-[50px] flex justify-center items-center px-4 bg-white border-b-1 border-zinc-200", children: ActionsArr.map((item, index) => {
...
export { full_editor_default as FullEditor };
